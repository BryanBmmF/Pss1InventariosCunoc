...
public interface EncargadoDAO extends CRUD<Encargado>{
    ...
    public static final String INSERTAR_ENCARGADO="INSERT INTO ENCARGADO (id_encargado,"
            + "registro_academico,nombre,apellido,cargo,division,estado) VALUES(?,?,?,?,?,?,?)";
    ...
    public static final String ACTUALIZAR_ENCARGADO="UPDATE ENCARGADO SET registro_academico = ?, "
            + "nombre = ?, apellido = ?, cargo = ?, division = ?, estado = ? WHERE id_encargado = ?";
