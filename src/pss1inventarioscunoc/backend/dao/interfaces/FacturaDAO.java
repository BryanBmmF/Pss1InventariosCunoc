...
public interface FacturaDAO extends CRUD<Factura> {
    ...
    public static final String BUSCAR_FACTURA_POR_DESCRIPCION = "SELECT t1.id_Factura,t1.id_Proveedor,t1.numero_Factura,t1.fecha,t1.descripcion,t1.valor,t2.nombre_Proveedor FROM FACTURA AS t1 LEFT JOIN PROVEEDOR AS t2 ON t1.id_Proveedor=t2.id_Proveedor WHERE t1.descripcion =?";
